...
> **Статус:** альфа-разработка. Этапы 1–4 завершены, этап 5 — полировка и релиз. См. [дорожную карту](ROADMAP.md).
...
- карточка репозитория: stars, forks, PR, issues, релизы, CI badge, heatmap, лента событий
- опрос GitHub API с ETag-кэшем и учётом rate limit
...
- клик по карточке открывает репозиторий в браузере
