...
> **Статус:** альфа-разработка. Этапы 1–2 завершены, этап 3 в работе. См. [дорожную карту](ROADMAP.md).
...
- окно настроек для ввода и проверки токена

### Пока в разработке

- выбор и сохранение списка репозиториев (сейчас по умолчанию `microsoft/vscode`)
- PR, issues, CI, heatmap, лента событий
- автозапуск и релиз v1.0
...
3. **Пауза** / **Продолжить** — приостановить рендер обоев.
