...
1. Скачайте `GitHubWallpaper.exe` из [последнего релиза](https://github.com/rkfsociety/GitHubWallpaper/releases/latest) — при каждом push в `main` CI пересоздаёт Release `latest` с актуальным exe.
