...
**Текущее состояние:** v1.0 — при push в `main` CI автоматически собирает exe, создаёт тег и GitHub Release.
...
- [x] Релизы публикуются автоматически при push в `main` (тег `v1.0.<build>` + exe)
