...
| 5 | [Полировка и релиз](#этап-5--полировка-и-релиз) | 🔄 В работе | Стабильный exe, CI/CD, документация |
| — | [Фаза 2 (будущее)](#фаза-2--будущее) | 💡 Идеи | Расширения после v1.0 |

**Текущее состояние:** v1.0.0 — portable exe, CI/CD, обработка ошибок API, проверка WebView2. Осталось опубликовать тег `v1.0.0` в Releases.
...
- [ ] Все 5 сценариев из раздела «Проверка» пройдены (ручная проверка перед тегом)
